...
* `themes/fitz-dark-italic-vscode-theme.json` - the color theme definition file.
...
* To share your extension with the world, read about [publishing](https://code.visualstudio.com/docs/extensions/publish-extension) an extension.
